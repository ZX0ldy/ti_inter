!function (u) {
    u.fn.stellarNav = function (n, r, h) {
        ...
        // ✅ SATU VAR f SAJA (digabung dengan konfigurasi WhatsApp)
        var f = u.extend({
            theme: "plain",
            breakpoint: 768,
            menuLabel: "Menu",
            ...
            closingDelay: 250,
            showArrows: !0,
            phoneBtn: "6282131648786", // Nomor WhatsApp
            phoneLabel: "WhatsApp",
            locationBtn: "https://wa.me/6282131648786?text=Halo%20saya%20tertarik%20dengan%20informasi%20Anda",
            locationLabel: "Chat Now",
            closeBtn: !1,
            closeLabel: "Close",
            mobileMode: !1,
            scrollbarFix: !1
        ...
        return this.each(function () {
            if ("light" != f.theme && "dark" != f.theme || nav.addClass(f.theme),
                ...
                f.phoneBtn && f.locationBtn) var n = "third";
            ...
            // ✅ Tombol WhatsApp langsung menuju nomor kamu
            if (f.phoneBtn && "right" != f.position && "left" != f.position) {
                var e = '<a href="https://wa.me/' + f.phoneBtn + '" class="call-btn-mobile ' + n + '" target="_blank"><svg id="icon-phone"></svg> <span>' + phoneLabel + "</span></a>";
                nav.find("a.menu-toggle").after(e);
            }

            // ✅ Tombol lokasi (menuju chat WA juga)
            ...
            if (f.sticky && (navPos = nav.offset().top, h <= r && u(window).on("scroll", function () {
                ...
                var i = '<span class="close-menu ' + n + '"><span class="icon-close"></span>' + closeLabel + "</span>",
                    s = '<a href="https://wa.me/' + f.phoneBtn + '" class="call-btn-mobile ' + n + '" target="_blank"><svg id="icon-phone"></svg></a>',
                    t = '<a href="' + f.locationBtn + '" class="location-btn-mobile ' + n + '" target="_blank"><svg id="icon-location"></svg></a>';
            ...
            f.closeBtn && "right" != f.position && "left" != f.position &&
            ...
            // ✅ Toggle dan menu behavior tetap sama
            u(".menu-toggle, .stellarnav-open").on("click", function (n) {
                n.preventDefault();
                "left" == f.position || "right" == f.position ?
                    (nav.find("ul:first").stop(!0, !0).fadeToggle(f.openingSpeed), nav.toggleClass("active"),
            ...
            u(".close-menu, .stellarnav-close").on("click", function () {
                ...
                "left" == f.position || "right" == f.position ?
                    ...
                    nav.find("ul:first").stop(!0, !0).slideUp(f.openingSpeed).toggleClass("active");
            });
